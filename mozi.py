...
display2.update_col(col=1, code=54)
display2.update_col(col=2, code=62)
display2.update_col(col=4, code=40)
display2.update_col(col=5, code=57)
display2.update_col(col=6, code=44)
display2.update_col(col=8, code=64)
display2.update_col(col=9, code=54)
display2.update_col(col=10, code=60)
display2.update_col(col=11, code=13)

display3.update_col(col=0, code=22)
display3.update_col(col=1, code=66)
display3.update_col(col=2, code=52)
display3.update_col(col=4, code=45)
display3.update_col(col=5, code=48)
display3.update_col(col=6, code=53)
display3.update_col(col=7, code=44)
display3.update_col(col=8, code=67)
